import PuntosAdminRow from '@/components/puntosAdminRow';
        ...
        <Dashboard>
            <div className="flex w-full flex-col p-6">
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="flex flex-row justify-between gap-4">
                                    ...
                                    <button className="bg-primary-orange col-span-2 h-[43px] w-full text-white">Registrar Punto de Venta</button>
                                </div>
                            </form>
                        </motion.div>
                    )}
                        ...
                        >
                            <form onSubmit={importarClientes} method="POST" className="relative rounded-lg bg-white text-black">
                                <div className="bg-primary-orange sticky top-0 flex flex-row items-center gap-2 rounded-t-lg p-4">
                                    ...
                                    <h2 className="text-2xl font-semibold text-white">Subir Puntos de ventas</h2>
                                </div>
                ...
                <div className="mx-auto flex w-full flex-col gap-3">
                    <h2 className="border-primary-orange text-primary-orange text-bold w-full border-b-2 text-2xl">Puntos de Venta</h2>
                    ...
                    <div className="flex w-full justify-center">
                        <table className="w-full border text-left text-sm text-gray-500 rtl:text-right dark:text-gray-400">
                            <thead className="bg-gray-300 text-sm font-medium text-black uppercase">
                                <tr>
                                    <td className="pl-5 text-left">PUNTO DE VENTA</td>
                    ...
                    <div className="mt-4 flex justify-center">
                        {puntosVenta.links && (
                            <div className="flex items-center">
                                {puntosVenta.links.map((link, index) => (
                                    <button
                                        key={index}
                                        ...
                                        } ${index === 0 ? 'rounded-l-md' : ''} ${index === puntosVenta.links.length - 1 ? 'rounded-r-md' : ''}`}
                    ...
                    <div className="mt-2 text-center text-sm text-gray-600">
                        Mostrando {puntosVenta.from || 0} a {puntosVenta.to || 0} de {puntosVenta.total} resultados
                    </div>
                </div>
            </div>
        </Dashboard>
