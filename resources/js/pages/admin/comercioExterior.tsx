    ...
    return (
        <Dashboard>
            ...
            <form onSubmit={handleSubmit} className="grid h-fit grid-cols-2 justify-between gap-5 p-6">
                ...
                {/* Sección 1 - imagen */}
                <ImagePicker name="image_seccion_dos" label="Imagen (600px Ancho) (440px Alto)" previewUrl={banner?.image_seccion_dos} data={data} setData={setData} />
                ...
                <ImagePicker name="image_seccion_tres" label="Imagen (600px Ancho) (440px Alto)" previewUrl={banner?.image_seccion_tres} data={data} setData={setData} />

                <ImagePicker
                    name="image_seccion_tres_dos"
                    label="Icono 1 (130px Ancho) (100px Alto)"
                ...
                <ImagePicker
                    ...
                    label="Icono 2 (130px Ancho) (100px Alto)"
