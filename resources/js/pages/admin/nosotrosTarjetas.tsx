...
import NosotrosTarjetaRow from '@/components/nosotrosTarjetaRow';
...
export default function NosotrosTarjetas() {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        post(route('admin.nosotros-tarjetas.store'), {
            preserveScroll: true,
            onSuccess: () => {
                    ...
                    <div className="flex w-full justify-center">
                        <table className="w-full border text-left text-sm text-gray-500 rtl:text-right dark:text-gray-400">
                            ...
                            <tbody className="text-center">
                                {tarjetas?.map((tarjeta) => <NosotrosTarjetaRow key={tarjeta.id} tarjeta={tarjeta} />)}
                            </tbody>
                        </table>
                    </div>
                </div>
