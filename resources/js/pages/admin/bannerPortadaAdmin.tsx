...
const FieldShell = ({ label, htmlFor, error, children }) => (
    <div className="w-full">
        ...
        <div className="mt-2">
            <div
                className={`flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 ${error ? 'outline-red-500' : 'outline-gray-300'
...
export default function BannerPortadaAdmin() {
    ...
    const initialData = useMemo(
        () => ({
            ...
            custom_title_es: banner?.custom_title_es ?? '',
            custom_title_en: banner?.custom_title_en ?? '',
            custom_image_es: null,
    ...
    const { data, setData, errors, processing, post, transform } = useForm(initialData);
    ...
    const TEXT_FIELDS = [
        ...
        { name: 'custom_title_es', label: 'Título personalizado (Español)' },
        { name: 'custom_title_en', label: 'Título personalizado (Inglés)' },
        // Sección 1
    ...
    const handleSubmit = (e) => {
        ...
        transform((formData) => {
            ...
            ['custom_image_es', 'image_banner', 'image_seccion_uno', 'image_seccion_dos'].forEach((field) => {
                if (!(cleanData[field] instanceof File)) {
                    delete cleanData[field];
                }
            });

            return cleanData as typeof formData;
        });
    ...
    return (
        <Dashboard>
            ...
            <form onSubmit={handleSubmit} className="grid h-fit grid-cols-2 justify-between gap-5 p-6">
                ...
                <SectionHeader>Formulario de inicio</SectionHeader>
                <TextInput
                    name="custom_title_es"
                    label="Título personalizado (Español)"
                    data={data}
                    setData={setData}
                    errors={errors}
                />
                ...
                <TextInput
                    ...
                    label="Título personalizado (Inglés)"
                    data={data}
                    setData={setData}
                    errors={errors}
                />
                ...
                <ImagePicker
                    name="custom_image_es"
                    label="Imagen personalizada (428px Ancho) (493px Alto)"
                    previewUrl={banner?.custom_image_es}
                    data={data}
                    setData={setData}
                />
                ...
                <MediaPicker name="image_banner" label="Imagen/Video (1366px Ancho) (655px Alto)" previewUrl={banner?.image_banner} data={data} setData={setData} />
                ...
                {/* Sección 1 - imagen */}
                <ImagePicker name="image_seccion_uno" label="Imagen (671px Ancho) (440px Alto)" previewUrl={banner?.image_seccion_uno} data={data} setData={setData} />
                ...
                {/* Sección 2 - imagen */}
                <ImagePicker name="image_seccion_dos" label="Imagen (1366px Ancho) (520px Alto)" previewUrl={banner?.image_seccion_dos} data={data} setData={setData} />
